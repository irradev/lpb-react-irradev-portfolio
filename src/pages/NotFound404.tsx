...
export const NotFound404 = () => {
    ...
    return (
        <div className="flex-grow flex flex-col justify-center items-center h-full max-w-lg mx-auto ">
            ...
            <div className="flex justify-center items-center w-full animate__animated animate__fadeInUp animate__slow">

                <button className="flex justify-center items-center gap-2 border border-gray-200 hover:border-gray-400 hover:scale-105 text-lg font-bold p-2 mt-2 w-full max-w-sm uppercase tracking-wide rounded-md shadow-lg text-shadow-xs transition-all duration-300 ease-out" style={{ animationDelay: `1.3s` }} onClick={() => navigate('/')}>
